...
private val BrandLight = lightColorScheme(
    ...
    onSurfaceVariant = Color(0xFF5F5B54), // 6.3:1 on light background — AA-safe body text
...
private val BrandDark = darkColorScheme(
    ...
    onSurfaceVariant = Color(0xFFB5B0A8), // 6.7:1 on dark background — AA-safe body text
